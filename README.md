...
4. Replace **060758616165** in the whole project with your AWS Account ID
...
# Datacenter Map
Remember to adjust **060758616165** in workflow before execution.
...
You also need to update task.json and replace **arn:aws:secretsmanager:eu-central-1:060758616165:secret:backend-secretsmanager-test-eu-central-1-ZE4OTx** with ARN of your secrets manager.
**REMEMBER!** Push all changes to your forked repository!
